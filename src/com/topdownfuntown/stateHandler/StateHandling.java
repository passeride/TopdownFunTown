package com.topdownfuntown.stateHandler;
...
public class StateHandling {
    ...
    public static void saveProgression(String path)throws Exception{
        int score = 100;
        String[] items;
    ...
    public static Object loadProgression(String filename) throws Exception{
