...
/**
 * Explotion is an effect that will spawn a visual
 * Push player back, and also do damadge
 */
public class Explotion extends GameObject {
    ...
    /**
     * Explotion will spawn a Explotion on the position given with a random rotation
     * This will push back and hurt player if close
     * @param position
     */
    public Explotion(Vector2 position) {
        super(position, Vector2.Vector2FromAngleInDegrees(Math.random() * 360), new AnimationSprite("effects/explotion", 11));
    ...
    void addForce(){
        ...
        player.rb2.addForce(Vector2.multiply(Vector2.Vector2FromAngleInDegrees(Vector2.getAngleBetweenInDegrees(getPosition(), player.getPosition())), force * forceMultiplier));
